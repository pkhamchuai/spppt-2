...
for i in dataset:
    # Run the test file
    subprocess.run(['.venv/bin/python', 'test_Rep.py', '--model', 'SP_AffineNet1alt', '--sup', '1', '--dataset', str(i), 
                    '--model_path', 'SP_AffineNet1_alt_11100_0.0001_0_20_1_20231108-094956.pth'])
